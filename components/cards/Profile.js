            ...
            >
              ...
              >
                <tr>
                  ...
                  <td style={{ color: '#426ab8' }}>{fullName}</td>
                </tr>
                {email && (
                  <tr>
                    <td style={{ paddingRight: 10 }}>email:</td>
                    <td style={{ color: '#426ab8' }}>{email}</td>
                  </tr>
                )}
                {cursus && (
                  <tr>
                    <td style={{ paddingRight: 10 }}>grade:</td>
                    <td style={{ color: '#426ab8' }}>{cursus.grade}</td>
                  </tr>
                )}
              </table>
            </div>
              ...
              >
                {leetLogo && (
                  ...
                  >
                    <path
                      fill="#111111"
                      d="M2.125 13.247h2.318V1.753H1.74v2.338H0V0h6.568v13.247h2.318V15H2.125v-1.753zM16.034 13.247h6.954V8.182h-6.375V6.429h6.375V1.753h-6.954V0h9.08v15h-9.08v-1.753zM31.681 13.247h6.955V8.182H32.26V6.429h6.375V1.753H31.68V0h9.08v15h-9.08v-1.753zM54.477 1.753H48.68v3.702h-1.738V0h9.465v15h-1.931V1.753z"
                    ></path>
                  </svg>
                )}
                {fortyTwoLogo && (
